        ...
        <div className="row d-flex">
          ...
          <div className="col-md-6 pl-md-5 py-md-5">
            <div className="heading-section pt-md-5 mb-4">
              ...
              <h2 className="mb-4">Connect, Grow and Serve with Us</h2>
              ...
              <p><strong>Our Founder</strong>: Late Frama Abraham was a renowned missionary with deep passion for souls who founded GOCI in 1996 after pioneering evangelism and church planting movements across northern Nigeria.</p>
              ...
              <p><a href="/about" className="btn btn-primary">Learn More About Us</a></p>
            </div>
          </div>
        </div>
      </div>
